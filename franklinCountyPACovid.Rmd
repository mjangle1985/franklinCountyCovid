...
franklinCountyCorona <- data.frame("day" = c(seq(1,12)), "dates" = seq(as.Date("2020-03-20"), by = "days", length.out = 12), "cases" = c(1, 1, 1, 1, 3, 5, 5, 5, 7, 11, 12, 19))
...
Useing the model to generate data for an additional amount of time. Placed in final model
