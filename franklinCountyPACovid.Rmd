...
daySinceFirstCase <- 19

franklinCountyCorona <- data.frame("day" = c(seq(1,daySinceFirstCase)), "dates" = seq(as.Date("2020-03-20"), by = "days", length.out = daySinceFirstCase), "cases" = c(1, 1, 1, 1, 3, 5, 5, 5, 7, 11, 12, 19, 21, 23, 26, 30, 32, 39, 43))
